...
const OIcon = preload("res://assets/images/icon_o.png")
...
func _ready():
	...
	area.connect("area_enter", self, "area_enter")
	area.connect("area_exit", self, "area_exit")
...
func draw_icon_string(icon_position, string, x_offset):
	draw_texture(OIcon, icon_position)
